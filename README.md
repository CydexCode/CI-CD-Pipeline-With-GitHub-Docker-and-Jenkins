...
1. **Clone Repository**: Clone this repository to your local machine using the following command:
   ```
   git clone [https://github.com/HGSChandeepa/GitHub-Docker-and-Jenkins-CI-CD-Pipeline](https://github.com/CydexCode/CI-CD-Pipeline-With-GitHub-Docker-and-Jenkin)
   ```
